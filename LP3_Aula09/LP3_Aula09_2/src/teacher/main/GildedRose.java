...
// Classe GildedRose modificada / refactoring do professor Diego Caldas.
...
public class GildedRose {
	...
	private void updateQualityByItem(final Item item) {
		if (!ItemUtil.hasType(item, ItemType.AGED_BRIE) && !ItemUtil.hasType(item, ItemType.BACKSTAGE_PASSES)) {
