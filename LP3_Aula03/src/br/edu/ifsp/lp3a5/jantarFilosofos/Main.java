...
import br.edu.ifsp.lp3a5.jantarFilosofos.solucao1.Mesa1;
import br.edu.ifsp.lp3a5.jantarFilosofos.solucao2.Mesa2;
import br.edu.ifsp.lp3a5.jantarFilosofos.solucao3.Mesa3;
...
public class Main {
	...
	public static void testeDeadlock() {
		...
		log.info("Neste exemplo o filósofo fica com um garfo na mão à "
				...
				+ "todos os filósofos ficam aguardando, sem comer ou " + "liberar o talher para os demais.");
	}
	...
	public static void testeOK() {
		...
		log.info("Neste exemplo o filósofo agarra o primeiro garfo e não o solta "
				...
				+ "os demais precisam esperar para conseguirem pegar um primeiro" + "garfo também.");
	}
