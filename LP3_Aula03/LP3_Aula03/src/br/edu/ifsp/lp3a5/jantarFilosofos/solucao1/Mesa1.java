package br.edu.ifsp.lp3a5.jantarFilosofos.solucao1;
...
public class Mesa1 extends AbstractMesa {
	...
	/**
	 * Método guloso de pegar os garfos. Fica segurando um garto enquanto não obtém
	 * os dois garfos.
	 */
	public void pegaGarfosGuloso(Filosofo filosofo) throws InterruptedException {
		...
		/*
		 * POLLING LOOP (laço de sondagem - apesar de ser um laço, não é o mesmo que
